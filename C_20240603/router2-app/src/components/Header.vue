<template>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark mt-2 header">
    <span class="navbar-brand" style="width: 200px">뉴진스(NewJeans)</span>
...
<style>
.header {
  background-color: rgb(126, 59, 148) !important;
}
</style>
